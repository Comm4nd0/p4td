...
class SupportQuery(models.Model):
    ...
    staff_has_unread = models.BooleanField(default=False, help_text='True from an owner message until staff reply or resolve — staff merely viewing the thread does not clear it')
