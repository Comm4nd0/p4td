...
class ReportFacilityDefectScreen extends StatefulWidget {
  ...
  @override
  State<ReportFacilityDefectScreen> createState() => _ReportFacilityDefectScreenState();
}
...
class _ReportFacilityDefectScreenState extends State<ReportFacilityDefectScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await _dataService.createFacilityDefect(
          ...
          children: [
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'e.g. Broken gate latch',
              ),
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'e.g. Main paddock, front gate',
              ),
              textCapitalization: TextCapitalization.sentences,
            ),
            const SizedBox(height: 16),
            TextFormField(
              ...
              decoration: const InputDecoration(
                ...
                hintText: 'What happened, when you noticed it…',
              ),
              textCapitalization: TextCapitalization.sentences,
              maxLines: 4,
            ),
